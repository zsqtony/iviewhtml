...
//                    {title: 'id',width:100,key: 'id'},
                    ...
                    {title: '分类',width:100,key: 'goods_type_name'},
                    {
                        title: '名称',
                        width:180,
                        key: 'name',
                ...
                headcourse:[
                    ...
                    {title: '分类',width:100,key: 'classes_type_name'},
                    {
                        title: '名称',
                        width:170,key: 'name',
                        tooltip:true,
            ...
            submit_ok_data(name){ //提交
                ...
                this.$refs[name].validate((valid) => {
                    if (valid) {
                        ...
                        //return false
                        _this.ApiPost('lines/store',_this.formValidate,function(json){
                            if(json.code == 1){
                                _this.success(_this,'提示','添加成功，系统正在更新')
                                setTimeout(()=>{
                                    _this.$router.replace({path: '/line/routelist'})
                                },600)
                            }
                            console.log(json,'提交')
                        })
